...
@EnableJpaRepositories(
    basePackages = "com.perpustakaan.service_buku.repository.command",
...
public class WriteDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean writeEntityManagerFactory(
        ...
        // 2. Mengatur strategi penamaan (buku -> buku)
        ...
        return builder
                ...
                .packages("com.perpustakaan.service_buku.entity.command")
